...
class TestIpaSequence(TestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(ipa_seq[0], IpaSequence(str(IPAString(unicode_string='aː'))))
        self.assertEqual(ipa_seq[1], IpaSequence(str(IPAString(unicode_string='b'))))
        self.assertEqual(ipa_seq[2], IpaSequence(str(IPAString(unicode_string='c'))))
